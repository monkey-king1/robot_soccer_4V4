...
namespace FieldPoint{
	...
	point2f Goal_Center_Left_One_Point(-FIELD_LENGTH / 2, -PENALTY_BISECTOR);//球门终点往正方向走一个等分点（正边半圆的圆心）
	point2f Goal_Center_Left_Two_Point(-FIELD_LENGTH / 2, -PENALTY_BISECTOR * 2);//球门终点往正方向走两个等分点
	point2f Goal_Center_Right_One_Point(-FIELD_LENGTH / 2, PENALTY_BISECTOR);//球门终点往负方向走一个等分点（负边半圆的圆心）
	point2f Goal_Center_Right_Two_Point(-FIELD_LENGTH / 2, PENALTY_BISECTOR * 2);//球门终点往负方向走一个等分点
	...
	point2f Penalty_Arc_Center_Right(-FIELD_LENGTH_H, PENALTY_AREA_L/2);//正边半圆的圆心
	point2f Penalty_Arc_Center_Left(-FIELD_LENGTH_H,-PENALTY_AREA_L/2);//负边半圆的圆心
	point2f Penalty_Rectangle_Left(-FIELD_LENGTH_H + PENALTY_AREA_R, -PENALTY_AREA_L / 2);//正边半圆的圆心对出来与门禁线的交点
	point2f Penalty_Rectangle_Right(-FIELD_LENGTH_H + PENALTY_AREA_R, PENALTY_AREA_L / 2);//负边半圆的圆心对出来与门禁线的交点
}
 namespace Maths{
